...
def generate_pdf(data, output_path):
    ...
    taux_rows = [
        ...
        [Paragraph("OAT 10 ans (France)", label_style),
         ...
         Paragraph(_fmt_period(data["spread"].get("oat_prev", "N/D"),
                               data["spread"].get("oat_prev_period", "N/D")), small_style),
         Paragraph(_fmt_period(data["spread"].get("oat_n1", "N/D"),
                               data["spread"].get("oat_n1_period", "N/D")), small_style),
